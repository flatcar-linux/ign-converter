...
import (
	...
	"github.com/flatcar/ignition/v2/config/v3_0"
	"github.com/flatcar/ignition/v2/config/v3_1"
	translateTo3_1 "github.com/flatcar/ignition/v2/config/v3_1/translate"
